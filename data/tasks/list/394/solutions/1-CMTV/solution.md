Из прото-задачи <b:[П-ссылка](advanced/proto/common/exp-monotonic)> мы знаем, что показательная функция с основанием $2$ монотонно возрастает на всей своей области определения.
