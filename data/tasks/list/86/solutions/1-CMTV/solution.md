...
Левая "последовательность" из $0$ стремится к $0$. Правая последовательность $\frac{1}{n}$ тоже стремится к $0$ (см. прото-задачу <b:[П-ссылка](advanced/proto/sequence-lim/elementary)>).
...
Получаем гармонический ряд, который расходится (см. прото-задачу <b:[П-ссылка](advanced/proto/sequence-lim/harmonic-series)>).
