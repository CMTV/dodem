...
Каждое слагаемое приведем к такому виду, чтобы было удобно использовать первый замечательный предел (<b:[П-ссылка](advanced/proto/f-lim/first-wonderful)>) вместе с теоремой о пределе сложной функции (<b:[П-ссылка](advanced/proto/f-lim/composition)>):
