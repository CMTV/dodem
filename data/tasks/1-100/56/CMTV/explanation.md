...
Последовательность $0\to 0$ и $\frac{1}{n}\to 0$ (см. прото-задачу <p:[sequences/limits/elementary]>), а значит, по теореме о двух милиционерах, "зажатая" между ними $\frac{1}{n+1}$ тоже стремится к $0$.